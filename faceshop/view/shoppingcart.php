    ...
    <script type="text/javascript">
        function submitForm(){
            $('#form').submit(function(e){
                e.preventDefault();
                if((jQuery.trim(document.getElementById('search').value)).length==0){
                    document.getElementById('search').focus();
                    document.getElementById('search').placeholder="Bạn cần nhập từ khóa tìm kiếm tại đây...";
                }else this.submit();
            });
        }
    </script>
        ...
        <div id="list" >
            <table>
                ...
                { ?>
                    ...
                    <div id="add_book"><b>Chọn thêm sách</b></div>
                    <div id="find_in" style="width: 450px; margin: auto; margin-top:15px;">
                        <div style="float: left;  margin-right: 15px; font-size: 20px;"><p><b>Tìm trong danh mục</b></p></div>
                        <div style="float: left;">
                            <ul>
                                <li><a href="index.php?id=category&idtype=1" style="color: red"> &#10059; Tiểu thuyết Việt Nam</a>
                                <span class="blink"> HOT</span></li>
                                <li><a href="index.php?id=category&idtype=3">&#10059; Truyện ngắn, tàn văn</a> </li>
                                <li><a href="index.php?id=category&idtype=5">&#10059; Truyện thiếu nhi</a> </li>
                                <li><a href="index.php?id=category&idtype=11">&#10059; Văn học Việt Nam</a> </li>
                                <li><a href="index.php?id=category&idtype=61">&#10059; Du lịch, văn hóa</a> </li>
                                <li><a href="index.php?id=category&idtype=3">&#10059; Truyện ngắn, tàn văn</a> </li>
                            </ul>
                        </div>
                        <div style="width: 450px; margin: auto; clear: both">
                            <div style=" margin-right: 15px; font-size: 20px;"><b>Hoặc tìm kiếm theo tên</b></div>
                            <div style="margin-top: 5px;">
                                <form action="index.php" method="get">
                                    <input id="search" name="search" type="text" value="<?php echo isset($_GET['search']) ? $_GET['search'] : '' ?>" placeholder="Nhập từ khóa"/>
                                    <button type="submit" onclick="submitForm();"><b>Tìm kiếm</b></button>
                                </form>
                            </div>
                        </div>
                    </div>
